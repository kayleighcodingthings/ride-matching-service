 ...
 *
 * <p>Request DTOs use regular classes (not records) so that Jackson can
 * deserialise nested objects via the default no-args constructor + setter
 * strategy, without requiring compiler flags or extra modules.
 *
 * <p>Response DTOs use records — Jackson serialises (writes) records
 * reliably via their accessor methods; only deserialisation is problematic.
 */
